    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
            <a class="navbar-brand" href="./home/home.html" target='content'>
                <img src="./home page images/medical-app1.png" width="178" height="70" class="d-inline-block align-top"
                    alt="">
            HealthConnect
            </a>
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li><a class="btn btn-outline-dark" href="./final/logout.html">Logout</a></li>
            </ul>
